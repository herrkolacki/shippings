...
<div class="zones index content">
    <?= $this->Html->link(__('New Zone'), ['action' => 'add'], ['class' => 'button float-right', 'style' => 'margin-left: 1.0rem']) ?>
    <?= $this->Html->link(__('Postcode from csv'), ['action' => 'addFromFile'], 
            ['class' => 'button float-right', 'style' => 'margin-left: 1.0rem']) ?>
    <?= $this->Html->link(__('Shippngs'), '/shippings', ['class' => 'button float-right']) ?>
    <h3><?= __('Zones') ?></h3>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('zone_amount') ?></th>
